...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div>\n        <div id=\"input-{{label}}\" class=\"input-group form-input-{{type}}\">\n            <label for=\"label-{{label | lowercase}}\">\n                {{label}}\n            </label>\n            <input name=\"{{label | lowercase}}\" class=\"form-control\" type=\"{{type}}\">\n        </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/var/www/Vue-Test/resources/assets/js/library/bootstrap-form/Input.vue"
  if (!module.hot.data) {
...
var _Input = require('./library/bootstrap-form/Input.vue');
...
},{"./library/bootstrap-form/Input.vue":4,"vue":3}]},{},[5]);
